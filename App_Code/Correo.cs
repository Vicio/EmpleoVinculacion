...
public class Correo
{
    ...
    public string enviarMailUsuario(string email, string nombre, string hash)
    {
        ...
        try
        {
            ...
            MailAddress correoServidor = new MailAddress("srim3000@hotmail.com", "Universidad Autónoma de Querétaro"); // correo del servidor
    ...
    public int enviarMailCambioPass(string email, string nombre, string hash)
    {
        ...
        MM.Body = "<a href=\"" + directorioServidor + "Principal/Verificacion.aspx?CambiarPassword=" + hash + "\" >Click aquí para cambiar su contraseña.</a>";
        MM.IsBodyHtml = true;
        MM.Priority = MailPriority.High; //prioridad del correo
